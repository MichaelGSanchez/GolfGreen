...
public class FavoriteAdapter extends RecyclerView.Adapter<FavoriteAdapter.FavoriteViewHolder> {
   ...
   * utilizes <code>favoriteList</code> to assign a place where the information is stored once it
   * is retrieved from the <code>onCreateViewHolder</code>
   ...
   * when they are calling other methods, and pulls from the .XML file <code>course_item</code>
   * that define what wil be in each place within the card and recyclerView.
   */
